...
var LedgerWallet = exports.LedgerWallet = function () {
  function LedgerWallet(web3, path) {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                // Nano throws and console hangs
                this.connectionOpened = true;
                _context2.t0 = _src2.default.eth;
                _context2.next = 8;
                return _src2.default.comm_node.create_async();
            ...
            switch (_context5.prev = _context5.next) {
              ...
              case 9:
                ...
                eth.getAddress_async(this._path, askForOnDeviceConfirmation, chainCode).then(function (result) {
                  _this2._accounts = [result.address.toLowerCase()];
                  cleanupCallback(null, _this2._accounts);
                }).catch(function (error) {
                  return cleanupCallback(error);
                });
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                this.web3.version.getNetwork(function () {
                      ...
                      while (1) {
                        switch (_context6.prev = _context6.next) {
                          case 0:
                            ...
                            _context6.next = 8;
                            return _this3._getLedgerConnection();
                          ...
                          case 8:
                            ...
                            eth.signTransaction_async(_this3._path, hex).then(function (result) {
            ...
            switch (_context8.prev = _context8.next) {
              case 0:
                return _context8.abrupt("return", new _promise2.default(function (resolve, reject) {
                  if (_u2fApi2.default && !_u2fApi2.default.getApiVersion) {
